...
- Uses the RISC-Zero zkVM to verifiably run Optimism's [Kona](https://github.com/anton-rs/kona) and secure rollups with cryptographic proofs enabling faster finality and reduced operational costs.
