    ...
    let server_task = match (use_hokulea, use_hana) {
        ...
        (true, _) => {
            ...
            start_server(
                ...
                hint.host,
                preimage.host,
                crate::hint_handler::FallbackBlobHintHandlerWithEigenDA::default(),
                providers,
                is_offline,
        ...
        (_, true) => {
            ...
            start_server(
                ...
                hint.host,
                preimage.host,
                crate::hint_handler::FallbackHanaHintHandler::default(),
                providers,
                is_offline,
        ...
        _ => start_server(
            ...
            hint.host,
            preimage.host,
            crate::hint_handler::FallbackBlobHintHandler::default(),
