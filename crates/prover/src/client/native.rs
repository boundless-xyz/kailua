    ...
    let server_task = match (use_hokulea, use_hana) {
        ...
        (true, _) => {
            ...
            start_server(
                ...
                hint.host,
                preimage.host,
                crate::hint_backoff::BackoffFallbackBlobHintHandlerWithEigenDA::default(),
                providers,
                is_offline,
        ...
        (_, true) => {
            ...
            start_server(
                ...
                hint.host,
                preimage.host,
                crate::hint_backoff::BackoffFallbackHanaHintHandler::default(),
                providers,
                is_offline,
        ...
        _ => start_server(
            ...
            hint.host,
            preimage.host,
            crate::hint_backoff::BackoffFallbackBlobHintHandler::default(),
